        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeStamp = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    NumLikes = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserRelationshipId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    User1Id = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    User2Id = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    NumNice = table.Column<int>(type: "int", nullable: false),
                    NumMean = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "varchar(255) CHARACTER SET utf8mb4", nullable: true)
                },
                constraints: table =>
                {
